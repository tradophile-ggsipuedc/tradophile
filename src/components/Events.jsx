  ...
  return (
    ...
    <div class="relative z-10 flex flex-col justify-center items-center space-y-2">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center mb-16 md:mb-24 ">
                <div className="w-5/6">
                    <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl shadow-xl p-6 transition-transform transform hover:scale-110 delay-100 duration-500 md:flex md:flex-row flex-col gap-5 mx-1 md:mx-8">
