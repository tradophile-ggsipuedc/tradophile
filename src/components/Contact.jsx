...
function Contact() {
  return (
    ...
    <div className='md:p-12 p-10 bg-gradient-to-r from-sky-950 via-cyan-800 to-sky-950 pt-40 md:pt-44 font-custom'>
     ...
     <div className='flex justify-center items-center p-10 font-custom'>
       <h1 className='text-white text-base font-semibold md:text-4xl text-center tracking-wide'> The Finance and Investment Society of GGSIPU EDC</h1>
     </div>

    <div className='md:px-36 md:py-10 md:pb-36 p-8 font-custom'>
     <div className="relative group">
              ...
              <div className="relative z-10 w-full bg-gradient-to-r from-cyan-950 to-sky-950 rounded-2xl shadow-md p-3 px-10 transition-transform transform group-hover:scale-100 group-hover:shadow-xl group-hover:shadow-indigo-500/50 flex justify-center items-center flex-col hover:bg-gray-800">
                <h1 className='text-center text-2xl md:text-4xl text-cyan-500 font-semibold pt-2 md:pt-4 pb-1'>Connect with Us</h1>
                ...
                <h1 className='md:text-xl text-sm'>@tradophile.ggsipuedc@gmail.com</h1>
                </div>

                 {/* LINE   */}
                 <div className='border-t-2 border-white w-full'></div>
                 <div className='flex flex-col gap-3 mt-4 mb-8 items-center'>
                 <h1 className='text-center text-lg text-nowrap md:text-4xl text-cyan-500 font-semibold pt-4 pb-1'>Join our Whatsapp Community</h1>
